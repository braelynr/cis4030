...
class _MyStatefulWidgetState extends State<MyStatefulWidget> {
  ...
  attractionCard(int index) {
    //print(attractions.guelphAttractions[index].toString());
...
class AddAttraction extends StatefulWidget {
  ...
  @override
  AddAttractionForm createState(){ return AddAttractionForm();}
}

class AddAttractionForm extends State<AddAttraction>{
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        ...
                        if (_formKey.currentState!.validate()) {
                          ...
                          Attraction newAttraction = Attraction(title.text, image.text, categories.text, address.text, description.text, true);
                          String jsonAttraction = jsonEncode(newAttraction);
                          //attractions.guelphAttractions.add(jsonAttraction); // does not work
                          //attractions.guelphAttractions.add('{\"title\": \"'+title.text+'\", \"address\": \"'+address.text+'\", \"imageURL\": \"'+image.text+'\", \"categories\": [\"'+categories.text+'\"], \"isFree\": true, \"description\": \"'+description.text+'\"}');
                          // jsonAttraction = {
                          //   "title": title.text,
                          ...
                          // }
                          // attractions.guelphAttractions.add(jsonAttraction);

                         // print(attractions.guelphAttractions[4].toString());
                          //Home createState() => Home();
                          attractions.guelphAttractions.add(    {
                            ...
                            "isFree": true,
                            "description": "This was created for testing purposes.",
                          });
                          print(attractions.guelphAttractions[5].toString());
                        }
                      },
...
class Attraction{
  ...
  List<String> catList = ['test'];// = categories.split(',');

  Attraction(this.title, this.imageURL, this.categories, this.address, this.description, this.isFree);
  Map toJson() => {
    'title': title,
    'address': address,
    'imageURL': imageURL,
    'catList': ['test', 'test2'], //catList,
    'isFree': isFree,
